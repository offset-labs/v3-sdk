...
import { BigintIsh, Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress } from '@offsetcarbon/sdk-core'
...
import ISwapRouter from '@offsetcarbon/v3-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'
