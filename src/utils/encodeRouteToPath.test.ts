import { Ether, Token, WETH9 } from '@offsetcarbon/sdk-core'
...
describe('#encodeRouteToPath', () => {
  ...
  it('wraps ether input for exact output multihop', () => {
    expect(encodeRouteToPath(route_weth_0_1, true)).toEqual(
      '0x0000000000000000000000000000000000000002000bb80000000000000000000000000000000000000001000bb8980b62da83eff3d4576c647993b0c1d7faf17c73'
    )
  })
  ...
  it('wraps ether output for exact output multihop', () => {
    expect(encodeRouteToPath(route_0_1_weth, true)).toEqual(
      '0x980b62da83eff3d4576c647993b0c1d7faf17c73000bb80000000000000000000000000000000000000002000bb80000000000000000000000000000000000000001'
    )
  })
})
