...
import IPeripheryPaymentsWithFee from '@offsetcarbon/v3-periphery/artifacts/contracts/interfaces/IPeripheryPaymentsWithFee.sol/IPeripheryPaymentsWithFee.json'
