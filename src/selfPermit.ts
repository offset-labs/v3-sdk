import { BigintIsh, Token } from '@offsetcarbon/sdk-core'
import { Interface } from '@ethersproject/abi'
import ISelfPermit from '@offsetcarbon/v3-periphery/artifacts/contracts/interfaces/ISelfPermit.sol/ISelfPermit.json'
