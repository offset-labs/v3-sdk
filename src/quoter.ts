...
import { BigintIsh, Currency, CurrencyAmount, TradeType } from '@offsetcarbon/sdk-core'
import { encodeRouteToPath, MethodParameters, toHex } from './utils'
import IQuoter from '@offsetcarbon/v3-periphery/artifacts/contracts/lens/Quoter.sol/Quoter.json'
import IQuoterV2 from '@offsetcarbon/swap-router-contracts/artifacts/contracts/lens/QuoterV2.sol/QuoterV2.json'
